...
%
% Creation: 13 Mar 2015 - Jeff Anderson   
% Updated:   6 Oct 2015 - Jeff Anderson - bug fixes
% Upedated: 19 Aug 2017 - Jeff Anderson - made case insensitive
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
count = 1;          
lowerKeys = lower(keys);
while count <= length(varargin)
    if ~isempty(varargin{count})
        if ismember(lower(varargin{count}),lowerKeys)
            key = varargin{count};
